...
import 'package:seven_movies/widgets/image_view.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Images of " + info.name, style: heading.copyWith(color: textColor)),
                  ),
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(14.0),
                    child: Text("Movies", style: heading.copyWith(color: textColor)),
                  ),
                  HorizontalListViewMovies(list: movies, color: textColor)
                ],
              ),
            ),
          if (movies.isNotEmpty) SliverToBoxAdapter(child: SizedBox(height: 10)),
          if (tv.isNotEmpty)
            SliverToBoxAdapter(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(14.0),
                    child: Text("Tv Shows", style: heading.copyWith(color: textColor)),
                  ),
...
class SliverAppBarCast extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SliverAppBar(
        pinned: true,
        stretch: true,
        brightness: textColor == Colors.black ? Brightness.light : Brightness.dark,
        elevation: 0,
