...
import 'package:seven_movies/constants.dart';
...
import 'package:seven_movies/screens/season_info_screen/bloc/season_detail_bloc.dart';
import 'package:seven_movies/screens/season_info_screen/season_details_screen.dart';
import 'package:seven_movies/screens/tvshow_info_screen/bloc/tv_show_detail_bloc.dart';
import 'package:seven_movies/widgets/app_bar.dart';
import 'package:seven_movies/widgets/cast_list.dart';
import 'package:seven_movies/widgets/expandable_group.dart';
import 'package:seven_movies/widgets/horizontal_list_cards.dart';
import 'package:seven_movies/widgets/like_button/cubit/like_movie_cubit.dart';
import 'package:seven_movies/widgets/like_button/fav_button.dart';
import 'package:seven_movies/widgets/loading.dart';
import 'package:seven_movies/widgets/no_results_found.dart';
import 'package:seven_movies/widgets/star_icon_display.dart';
import 'package:seven_movies/widgets/trailer_widget.dart';
...
class _TvShowDetailScreenState extends State<TvShowDetailScreen> {
  ...
  getColor() async {
    List<Color> colors = await color.getImagePalette(Image.network(widget.backdrop).image);
    setState(() {
        ...
        body: BlocBuilder<TvShowDetailBloc, TvShowDetailState>(
          builder: (context, state) {
            if (state is TvShowDetailLoaded)
              ...
              return ErrorPage();
            else if (state is TvShowDetailLoading) return Loading(image: widget.backdrop);
    ...
    return Container(
      ...
      child: CustomScrollView(
        ...
        slivers: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                IconTheme(
                                  data: IconThemeData(
                                    color: textColor == Colors.white ? Colors.amber : Colors.blue,
                                    size: 20,
                                  ),
                                  child: StarDisplay(
                            ...
                            SizedBox(height: 5),
                            BlocProvider(
                              create: (context) => LikeMovieCubit()..init(info.tmdbId),
                              child: FavirIcon(
                                ...
                                title: info.title,
                                movieid: info.tmdbId,
                                likeColor: textColor == Colors.black ? Colors.blue : Colors.amber,
          ...
          if (info.overview != '') OverviewWidget(textColor: textColor, info: info),
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Cast", style: heading.copyWith(color: textColor)),
                  ),
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(14.0),
                    child: Text("You might also like", style: heading.copyWith(color: textColor)),
                  ),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(
                            style: normalText.copyWith(color: textColor, fontWeight: FontWeight.bold),
                            children: [
                              TextSpan(
                        ...
                        ReadMoreText(
                          ...
                          style: normalText.copyWith(fontWeight: FontWeight.w500, color: textColor),
