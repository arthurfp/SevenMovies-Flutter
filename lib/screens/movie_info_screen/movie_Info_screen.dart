...
import 'package:seven_movies/screens/movie_info_screen/bloc/movie_info_bloc.dart';
              ...
              child: Row(
                ...
                children: [
                  Flexible(
                    flex: 1,
                    child: Container(
                      child: CachedNetworkImage(imageUrl: info.poster, width: 120),
                    ),
                  ),
                  Expanded(
                    flex: 2,
              ...
              child: ExpandableGroup(
                ...
                items: [
                  ...
                  ListTile(
                      ...
                      subtitle: Text(
                        k_m_b_generator(info.budget) == "0" ? "N/A" : k_m_b_generator(info.budget),
                        style: normalText.copyWith(color: textColor),
                      )),
                  ListTile(
                    title: Text(
