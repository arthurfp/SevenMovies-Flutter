...
import 'package:seven_movies/models/season_details_model.dart';
import 'package:seven_movies/screens/cast_info_screen/cast_info_screen.dart';
      ...
      child: CustomScrollView(
        ...
        slivers: [
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  ReadMoreText(
                    info.overview == "N/A" ? "${info.name} premiered on " + info.customDate : info.overview,
                    trimLines: 8,
          ...
          if (trailers.isNotEmpty)
            TrailersWidget(textColor: textColor, trailers: trailers, backdrops: backdrops, backdrop: backdrop),
            ...
            SliverToBoxAdapter(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(14.0),
                    child: Text("Episodes", style: heading.copyWith(color: textColor)),
                  ),
                ],
              ),
            ),
                          ...
                          Positioned(
                              child: Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(info.episodes[i].number, style: heading.copyWith(color: textColor)),
                                  )))
                        ],
                      ),
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              text: TextSpan(
                                children: [
                                  TextSpan(
                                    ...
                                    style: heading.copyWith(color: textColor, fontSize: 20),
                                  ),
                                ],
                              ),
                            ),
                            Text(
                              ...
                              style: heading.copyWith(color: textColor.withOpacity(.8), fontSize: 18),
                            ),
                            SizedBox(height: 5),
                            Row(
                              children: [
                                IconTheme(
                                  data: IconThemeData(
                                    color: textColor == Colors.white ? Colors.amber : Colors.white,
                                    size: 20,
                                  ),
                                  child: StarDisplay(
                                    value: ((info.episodes[i].voteAverage * 5) / 10).round(),
                                  ),
                                ),
                                Text(
                                  "  " + info.episodes[i].voteAverage.toString() + "/10",
          ...
          children: [
            ...
            Positioned(
                child: Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text(model.number, style: heading.copyWith(color: textColor)),
                    )))
          ],
        ),
        Padding(
          ...
          Container(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding: const EdgeInsets.all(14.0),
                  child: Text("Guest stars", style: heading.copyWith(color: textColor)),
                ),
                CastList(castList: model.castInfoList, textColor: textColor),
              ],
            ),
          ),
      ]),
