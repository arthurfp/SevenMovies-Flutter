                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              width: 1.5,
                              color: currentPage == 0 ? Colors.white : Colors.white,
                            ),
                            borderRadius: BorderRadius.circular(16)),
                        child: Text(
                          "Favorites",
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              width: 1.5,
                              color: currentPage == 1 ? Colors.white : Colors.white,
                            ),
                            borderRadius: BorderRadius.circular(16)),
                        child: Text(
                          "watchlist",
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border: Border.all(
                              width: 1.5,
                              color: currentPage == 2 ? Colors.white : Colors.white,
                            ),
                            borderRadius: BorderRadius.circular(16)),
                        child: Text(
                          "collections",
                                    ...
                                    Row(
                                      children: [
                                        IconTheme(
                                          ...
                                          child: StarDisplay(
                                            value: ((widget.movie.rate * 5) / 10).round(),
                                          ),
                                        ),
                                        Text(
