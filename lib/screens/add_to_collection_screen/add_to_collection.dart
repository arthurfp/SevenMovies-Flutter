                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: TextField(
                            ...
                            style: heading.copyWith(color: Colors.white, fontSize: 24),
                            autofocus: true,
                          ...
                          actions: [
                            TextButton(
                              ...
                              child: Text(
                                "CANCEL",
                                style: normalText.copyWith(color: Colors.white, fontSize: 15),
                              ),
                            ),
                            TextButton(
                                onPressed: () async {
                                  ...
                                  FirebaseFirestore.instance
                                      ...
                                      .doc(con.text)
                                      .set({"name": con.text, "image": image, "time": DateTime.now()});
                                  FirebaseFirestore.instance
                                      .collection('UserCollections')
                                      .doc(devid)
                            ...
                            .map((coll) => Padding(
                                  ...
                                  child: ListTile(
                                    onTap: () {
                                      ...
                                      Fluttertoast.showToast(
                                        msg: "Added to collection ${coll['name']}",
                                        toastLength: Toast.LENGTH_SHORT,
                                        gravity: ToastGravity.CENTER,
                                      );
                                      Navigator.of(context).pop();
