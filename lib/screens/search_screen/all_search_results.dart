...
import 'package:seven_movies/screens/cast_info_screen/bloc/castinfo_bloc.dart';
import 'package:seven_movies/screens/cast_info_screen/cast_info_screen.dart';
import 'package:seven_movies/screens/search_screen/bloc/search_results_bloc.dart';

import 'package:seven_movies/screens/search_screen/search_results/all_movies_search_results.dart';
import 'package:seven_movies/screens/search_screen/search_results/all_people_search_results.dart';
import 'package:seven_movies/screens/search_screen/search_results/all_tv_search_results.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          if (movies.isEmpty && shows.isEmpty && people.isEmpty) Center(child: NoResultsFound()),
                    ...
                    text: TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          ...
                          style: heading.copyWith(fontWeight: FontWeight.bold, color: Colors.white.withOpacity(.6)),
                        ),
                      ],
                    ),
                  ),
