...
import 'package:seven_movies/screens/add_to_collection_screen/add_to_collection.dart';
    ...
    return BlocBuilder<CollectionCubit, CollectionState>(
      builder: (context, state) {
        return ListTile(
            ...
            title: Text(
              !state.isCollection ? " Add to Collection" : " Already in ${state.collectionname}",
