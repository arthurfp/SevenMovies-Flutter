    ...
    return BlocBuilder<WatchlistCubit, WatchlistState>(
      builder: (context, state) {
        return InkWell(
          ...
          child: Container(
            child: ListTile(
              leading: Icon(!state.isWatchlist ? Icons.bookmark_add : Icons.bookmark,
                  color: state.isWatchlist ? likeColor : unLikeColor, size: 35),
              title: Text(
                !state.isWatchlist ? "add to Watch list" : "Added to watch list",
