...
class FetchMovieDataById {
  Future<List<dynamic>> getDetails(String id) async {
    ...
    var moviedataByIdurl = 'https://api.themoviedb.org/3/movie/$id?api_key=84ebd14770d7675041b532f1d88ce324';
    var trailersUrl =
    ...
    var smiliarmovieUrl = 'https://api.themoviedb.org/3/movie/$id/similar?api_key=84ebd14770d7675041b532f1d88ce324';
    ...
    final omdbResponse = await http.get('http://www.omdbapi.com/?i=$imdbId&apikey=114165f2');
    ...
    if (responses[2].statusCode == 200) {
      backdropsData = ImageBackdropList.fromJson(responses[2].data['backdrops']);
    } else {
      throw FetchDataError('Error Fetching data');
    }
