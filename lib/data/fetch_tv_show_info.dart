...
class FetchTvShowDetail {
  Future<List<dynamic>> getTvDetails(String id) async {
    var http = Dio();
    var dataUrl = 'https://api.themoviedb.org/3/tv/$id?api_key=84ebd14770d7675041b532f1d88ce324';
    var trailersurl =
    ...
    var similarurl = 'https://api.themoviedb.org/3/tv/$id/similar?api_key=84ebd14770d7675041b532f1d88ce324';
    ...
    var res = await Future.wait(
        [http.get(dataUrl), http.get(trailersurl), http.get(imagesurl), http.get(casturl), http.get(similarurl)]);
