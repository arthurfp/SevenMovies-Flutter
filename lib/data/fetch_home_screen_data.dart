...
class FetchHomeRepo {
  Future<List<dynamic>> getHomePageMovies() async {
    var http = Dio();
    var trandingurl = 'https://api.themoviedb.org/3/trending/movie/day?api_key=84ebd14770d7675041b532f1d88ce324';
    var nowPlayingurl = 'https://api.themoviedb.org/3/movie/now_playing?api_key=84ebd14770d7675041b532f1d88ce324';
    var topRatedurl =
        'https://api.themoviedb.org/3/movie/top_rated?api_key=84ebd14770d7675041b532f1d88ce324&page=${Random().nextInt(100)}';
    var tvshowurl = 'https://api.themoviedb.org/3/trending/tv/day?api_key=84ebd14770d7675041b532f1d88ce324';
    ...
    var upcomingMoviesUrl = 'https://api.themoviedb.org/3/movie/upcoming?api_key=84ebd14770d7675041b532f1d88ce324';
