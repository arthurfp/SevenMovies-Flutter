import 'package:seven_movies/models/formated_time_genrator.dart';
...
class EpisodeModel {
  ...
  factory EpisodeModel.fromJson(json) {
    ...
    return new EpisodeModel(
      ...
      castInfoList: (json['guest_stars'] as List).map((star) => CastInfo.fromJson(star)).toList(),
      customDate: string,
    );
  }
}
  ...
  factory SeasonModel.fromJson(json) {
    ...
    return SeasonModel(
      ...
      posterPath: json['poster_path'] != null
          ...
          : "https://images.pexels.com/photos/4089658/pexels-photo-4089658.jpeg?cs=srgb&dl=pexels-victoria-borodinova-4089658.jpg&fm=jpg",
      seasonNumber: json['season_number'].toString(),
      episodes: (json['episodes'] as List).map((episode) => EpisodeModel.fromJson(episode)).toList(),
      customDate: string,
    );
  }
}
